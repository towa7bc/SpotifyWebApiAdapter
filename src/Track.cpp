...
Track::Track(const model::track &t_track)
    : available_markets(t_track.available_markets),
...
Track::Track(model::track &&t_track) noexcept
    : available_markets(std::move(t_track.available_markets)),
...
Track::Track(const model::savedtrack &t_track)
    : available_markets(t_track.track_.available_markets),
...
Track::Track(model::savedtrack &&t_track) noexcept
    : available_markets(std::move(t_track.track_.available_markets)),
