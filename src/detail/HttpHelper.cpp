...
/* static */ auto detail::HttpHelper::get2(
        std::string_view url, const AuthenticationToken &token, bool include_bearer) -> std::string {
...
/* static */ auto detail::HttpHelper::post3(
        std::string_view url, const AuthenticationToken &token,
        const model::playlistdata &pD, bool include_bearer) -> std::string {
    nlohmann::json j = pD;
...
/* static */ auto detail::HttpHelper::put2(
        std::string_view url, const AuthenticationToken &token,
        const model::playlistdata &pD, bool include_bearer) -> std::string {
    nlohmann::json j = pD;
...
/* static */ auto detail::HttpHelper::delete_(
        std::string_view url, const AuthenticationToken &token, bool include_bearer) -> std::string {
